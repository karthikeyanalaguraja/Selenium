...
public class LoginTests extends BaseCommunityTest {
    ...
    @TestCase(owner = Owner.Karthik, testId = 101)
    ...
    @TestCase(owner = Owner.Karthik, testId = 102)
    ...
    @TestCase(owner = Owner.Karthik, testId = 103)
    ...
    @TestCase(owner = Owner.Karthik, testId = 104)
